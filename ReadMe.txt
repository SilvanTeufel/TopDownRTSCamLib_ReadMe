...
Here is a List of the Classes and there Functions:
	...
	-> CameraPawn
		...
		void PanMoveCamera(const FVector& PanDirection);    // Scrolling with Screen Edges This is Called in Tick generaly with CamSpeed - PanMoveCamera(GetCameraPanDirection() * CamSpeed);
		float Margin = 15;
		...
		void LockOnCharacter(ACharacter* SelectedActor);    // Can be called to Lock the Camera to an Actor, ZoomCamOutToPosition is checked
